...
$execute \
    as @n[sort=arbitrary,tag=cse.status_effect.sneaking_speed.id.$(id),tag=cse.status_effect.sneaking_speed.data_target,tag=cse.status_effect.sneaking_speed.data,distance=0..,type=marker] run \
