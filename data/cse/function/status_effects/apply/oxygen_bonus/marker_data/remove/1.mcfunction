...
scoreboard players reset #reset.oxygen_bonus cse.global.main
...
function cse:status_effects/apply/oxygen_bonus/marker_data/remove/3 with storage cse:status_effects.id.uuid temp

execute \
    if score #reset.oxygen_bonus cse.global.main matches 1 run \
function cse:status_effects/apply/oxygen_bonus/marker_data/remove/6