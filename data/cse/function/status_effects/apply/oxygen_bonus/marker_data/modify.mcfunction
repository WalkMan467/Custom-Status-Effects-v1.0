...
$execute \
    as @n[sort=arbitrary,tag=cse.status_effect.oxygen_bonus.id.$(id),tag=cse.status_effect.oxygen_bonus.data_target,tag=cse.status_effect.oxygen_bonus.data,distance=0..,type=marker] run \
