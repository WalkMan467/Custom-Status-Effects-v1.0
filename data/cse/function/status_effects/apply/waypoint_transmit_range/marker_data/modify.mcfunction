...
tag @s add cse.status_effect.waypoint_transmit_range.user

execute \
    as @e[tag=cse.status_effect.waypoint_transmit_range.data,distance=0..,type=marker] \
    if score @s cse.status_effects.waypoint_transmit_range.id = @n[tag=cse.status_effect.waypoint_transmit_range.user,tag=cse.status_effect.waypoint_transmit_range.data_target,distance=0..,type=!#cse:dummy_mob] cse.status_effects.waypoint_transmit_range.id run \
tag @s add cse.status_effect.waypoint_transmit_range.data_target
...
tag @s remove cse.status_effect.waypoint_transmit_range.user

tag @e[sort=arbitrary,tag=cse.status_effect.waypoint_transmit_range.data_target,tag=cse.status_effect.waypoint_transmit_range.data,distance=0..,type=marker] remove cse.status_effect.waypoint_transmit_range.data_target