...
$execute \
    as @n[sort=arbitrary,tag=cse.status_effect.max_absorption.id.$(id),tag=cse.status_effect.max_absorption.$(type),tag=cse.status_effect.max_absorption.data_target,tag=cse.status_effect.max_absorption.data,distance=0..,type=marker] run \
function cse:status_effects/apply/max_absorption/marker_data/math {duration:$(duration),value:$(value), max:$(max)}

$attribute @s minecraft:max_absorption modifier remove cse.status_effects.max_absorption.$(id).$(type)
...
$data modify storage cse:status_effects max_absorption.final_value.type set value "$(type)"
...
data modify storage temp2 temp set from storage cse:status_effects max_absorption.final_value
