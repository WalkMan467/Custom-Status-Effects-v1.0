...
scoreboard players reset #reset.max_absorption cse.global.main
...
function cse:status_effects/apply/max_absorption/marker_data/remove/3 with storage cse:status_effects.id.uuid temp

execute \
    if score #reset.max_absorption cse.global.main matches 1 run \
function cse:status_effects/apply/max_absorption/marker_data/remove/6