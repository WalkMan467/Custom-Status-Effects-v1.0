tag @s add cse.status_effect.explosion_knockback_resistance.data_target.reset
tag @s add cse.status_effect.explosion_knockback_resistance.data_target.kill
