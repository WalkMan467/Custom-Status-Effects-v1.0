...
$execute \
    as @n[sort=arbitrary,tag=cse.status_effect.explosion_knockback_resistance.id.$(id),tag=cse.status_effect.explosion_knockback_resistance.data_target,tag=cse.status_effect.explosion_knockback_resistance.data,distance=0..,type=marker] run \
