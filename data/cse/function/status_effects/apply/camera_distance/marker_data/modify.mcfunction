...
$execute \
    as @n[sort=arbitrary,tag=cse.status_effect.camera_distance.id.$(id),tag=cse.status_effect.camera_distance.data_target,tag=cse.status_effect.camera_distance.data,distance=0..,type=marker] run \
