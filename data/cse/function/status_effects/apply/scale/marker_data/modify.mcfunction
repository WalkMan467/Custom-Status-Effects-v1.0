...
$execute \
    as @n[sort=arbitrary,tag=cse.status_effect.scale.id.$(id),tag=cse.status_effect.scale.data_target,tag=cse.status_effect.scale.data,distance=0..,type=marker] run \
