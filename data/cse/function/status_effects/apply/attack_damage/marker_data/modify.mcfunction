...
$execute \
    as @n[sort=arbitrary,tag=cse.status_effect.attack_damage.id.$(id),tag=cse.status_effect.attack_damage.data_target,tag=cse.status_effect.attack_damage.data,distance=0..,type=marker] run \
