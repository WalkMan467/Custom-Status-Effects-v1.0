...
$execute \
    as @n[sort=arbitrary,tag=cse.status_effect.entity_interaction_range.id.$(id),tag=cse.status_effect.entity_interaction_range.data_target,tag=cse.status_effect.entity_interaction_range.data,distance=0..,type=marker] run \
