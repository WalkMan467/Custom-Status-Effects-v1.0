...
$execute \
    as @n[sort=arbitrary,tag=cse.status_effect.attack_knockback.id.$(id),tag=cse.status_effect.attack_knockback.$(type),tag=cse.status_effect.attack_knockback.data_target,tag=cse.status_effect.attack_knockback.data,distance=0..,type=marker] run \
...
$data modify storage cse:status_effects attack_knockback.final_value.type set value "$(type)"
...
data modify storage temp2 temp set from storage cse:status_effects attack_knockback.final_value
