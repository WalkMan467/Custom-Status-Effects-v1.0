...
$execute \
    ...
    if score @s cse.status_effects.water_movement_efficiency.id = @n[sort=arbitrary,tag=cse.status_effect.water_movement_efficiency.data_target.reset,tag=cse.status_effect.water_movement_efficiency.id.$(id),tag=cse.status_effect.water_movement_efficiency.data,distance=0..,type=marker] cse.status_effects.water_movement_efficiency.id run \
function cse:status_effects/apply/water_movement_efficiency/marker_data/remove/4 {id:"$(id)"}