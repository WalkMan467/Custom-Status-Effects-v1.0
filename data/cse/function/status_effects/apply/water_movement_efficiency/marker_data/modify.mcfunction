...
$execute \
    as @n[sort=arbitrary,tag=cse.status_effect.water_movement_efficiency.id.$(id),tag=cse.status_effect.water_movement_efficiency.data_target,tag=cse.status_effect.water_movement_efficiency.data,distance=0..,type=marker] run \
