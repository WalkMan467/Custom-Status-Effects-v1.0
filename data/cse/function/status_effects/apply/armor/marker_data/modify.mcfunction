...
$execute \
    as @n[sort=arbitrary,tag=cse.status_effect.armor.id.$(id),tag=cse.status_effect.armor.data_target,tag=cse.status_effect.armor.data,distance=0..,type=marker] run \
